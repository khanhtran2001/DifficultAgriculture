...
class DotaYoloDetectionDataset():
	"""
	Dataset class for the DOTA/DOTA-v2 dataset in YOLO format for object detection tasks.
	This class implements the DatasetInterface and provides methods for loading, validating, and retrieving properties of the DOTA dataset.
	...
	def __init__(self, dataset_config: DatasetConfig):
		"""
		Initialize the DotaYoloDetectionDataset with the provided dataset configuration.
		"""
