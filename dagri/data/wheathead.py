...
class WheatHeadYoloDetectionDataset():
    """
    Dataset class for the Global Wheat Head dataset in YOLO format for object detection tasks.
    This class implements the DatasetInterface and provides methods for loading, validating, and retrieving properties of the Global Wheat Head dataset.
    ...
    def __init__(self, dataset_config: DatasetConfig):
        """
        Initialize the WheatHeadYoloDetectionDataset with the provided dataset configuration.
        """
