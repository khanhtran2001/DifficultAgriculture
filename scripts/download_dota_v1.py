...
Examples:
  ...
  python scripts/download_dota_v1.py --output-dir /custom/path

  # Skip download, only convert existing DOTA-v1
  python scripts/download_dota_v1.py --skip-download

  # Download only (no conversion)
  python scripts/download_dota_v1.py --download-only
		"""
	)
	parser.add_argument(
		"--output-dir",
